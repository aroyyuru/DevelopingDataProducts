...
# ui.R file for the shiny app course project
# App for mileage calculation and cars comparison
library(shiny)
library(markdown)
shinyUI(navbarPage("App for mileage calculation and cars comparison",
                   tabPanel("Home",
                            # Sidebar
                            sidebarLayout(
                              sidebarPanel(
